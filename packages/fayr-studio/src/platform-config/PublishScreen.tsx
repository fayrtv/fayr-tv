...
export default function PublishScreen() {
    const [selected, setSelected] = useState(PUBLISHING_OPTIONS[0]);

    const { platformId } = React.useContext(PlatformConfiguratorContext);

    return (
        <>
            <A
                href={`http://localhost:3000/preview/${platformId}`}
                className="mb-3 relative inline-flex items-center bg-indigo-500 p-2 rounded-md text-sm font-medium text-white hover:bg-indigo-600 focus:outline-none focus:z-10 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
            >
                Preview
            </A>
