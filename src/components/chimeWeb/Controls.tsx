...
const Controls: React.FC<Props & ReduxProps> = ({ chime, title, openSettings, unreadMessages, role, ssName, baseHref, history }) => {
	...
	const micSvg = localMuted
		? (
			<svg className={styles.BtnSvg} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	const buttons = [		
		...
		(
			<button key="SettingsButton" className={`${styles.Button} btn rounded btn--settings`} onClick={withSuppressedBubble(() => {
				...
				<svg className={styles.BtnSvg} fill="white" xmlns="http://www.w3.org/2000/svg">
		...
		(
			<button key="EndButton" className={`${styles.Button} btn rounded btn--leave btn--destruct`} onClick={withSuppressedBubble(endButtonOnClick)}>
				<svg className={styles.BtnSvg} xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="square" strokeLinejoin="round">
		...
		(
			<button key="NoiseCancellingButton" className={`${styles.Button} ${mic_controls} btn rounded btn--mic`} onClick={withSuppressedBubble(muteButtonOnClick)}>
				<svg className="" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" fill="none" strokeWidth="2" strokeLinecap="butt" strokeLinejoin="round">
		...
		(
			<button key="SharePartyButton" className={`${styles.Button} btn rounded popup`} onClick={withSuppressedBubble(handleRoomClick)}>
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
		...
		(
			<div key="ChatButton" className={`${styles.Button} ${styles.ChatContainer}`}>
